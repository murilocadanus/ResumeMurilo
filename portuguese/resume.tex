...
\begin{document}
  ...
  Arquiteto de software e programador com 12 anos de experiência em desenvolvimento de software corporativo, desktop e mobile. \\
    ...
    \begin{rSubsection}{Conhecimentos}{}{}{}
      \item {\bf Conceitos:} Design Patterns, OOP, UML, Scrum, Agile, SOA, BPM, TDD, BDD.
      \item {\bf Linguagens de programação:} C/C++/Objective-C et Java.
      ...
      % \item Portability and security
      % \item Engine/Framework development
      % \item Clean, modular and high maintainable code
      % \item Object Oriented design
      % \item C/C++/C\#/Assembly and script based languages
      % \item Problem solving skills
      % \item Network programming
      % \item Tools programming
    \end{rSubsection}
    % \begin{rSubsection}{Tools}{}{}{}
    %   \item IDEs: MS Visual Studio, Metrowerks Codewarrior, Code::Blocks, QtCreator, Eclipse, ViM
    %   \item Tools: Perforce, Jenkins, SN-DBS, FASTBuild, CMake, Ninja, Jam, Clang/LLVM
    %   \item APIs: Orbis, XDK, RVL, CTR; GNM, OpenGL, DirectX, SDL; OpenAL, FMOD, WWise, CRI, Bink; iOS SDK
    %   \item Engines: Gamebryo, Terminal Reality Infernal Engine, Unity3D
    % \end{rSubsection}
  \end{rSection}
  \begin{rSection}{Experiência profissional}
    ...
    \item Projeto REVERSE (\url{https://itunes.apple.com/br/app/reverse/id989345278}) – Aplicativo de comércio eletrônico onde os anuncios são de compras de produtos. Atuei no desenvolvimento utilizando \textbf{Obj-C} e \textbf{Xcode}, usando os pods , \textbf{AFNetworking} para chamadas remotas a \textbf{WebServices}, \textbf{SDWebImage} para cache de imagens, \textbf{XMPPFramework} para troca de mensagens e \textbf{WebRTC} para video e audio chamada. Usei o \textbf{Git} para gerenciar versões e o código fonte.\\
